...
public final class TestGanglinienParameterSetzer
	...
	public static void main(final String[] args) {
		StandardApplicationRunner.run(new TestGanglinienParameterSetzer(),
				args);
	}
	...
	public void initialize(final ClientDavInterface connection) {
		...
		for (final SystemObjekt so : objekte) {
			...
			datumGanglinie = GlSpeicher.getInstanz().read(mq.getPid());

			pdPrognose = mq
					.getParameterDatensatz(PdGanglinienModellPrognose.class);
			datumPrognose = pdPrognose.erzeugeDatum();
			datumPrognose.setAuswahlMethode(
					PdGanglinienModellPrognose.Daten.WAHRSCHEINLICHSTE_GANGLINIE);
			datumPrognose
