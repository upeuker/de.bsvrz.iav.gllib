 ...
 * <tt>listIterator</tt> methods are <i>fail-fast</i>: if list is
...
public class MeinArrayList<E> extends AbstractList<E> implements List<E>,
	 ...
	 */
	public MeinArrayList(int initialCapacity) {
		super();
	 ...
	 */
	public MeinArrayList(Collection<? extends E> c) {
		size = c.size();
	...
	public Object clone() {
		try {
			MeinArrayList<E> v = (MeinArrayList<E>) super.clone();
